...
int main(int argc, char *argv[])
{
   ...
   if (argc < 2) {
      ...
      cout << "                                        \n";
      cout << "Program usage: ./program <threshold>    \n";
...
{
   int errors = 0;
   cout << endl << "unit test running..." << endl << endl;
   ...
   for (int i=0; i<159; i++) {
      ...
      double diff = data[i][2] - getPonderal(data[i][0], data[i][1]);
      if (diff > threshold) {
   ...
   cout << endl << errors << " errors found." << endl;
   cout << "end-of-unit-test" << endl << endl;;
}
